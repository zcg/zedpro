...
messages!(
    ...
    (StartRemoteDevContainer, Background),
    (RemoteDevContainerStarted, Background),
    (RemoteDevContainerConnection, Background),
    (RemoteDevContainerProgress, Background),
...
request_messages!(
    ...
    (StartRemoteDevContainer, RemoteDevContainerStarted),
...
entity_messages!(
    ...
    StartRemoteDevContainer,
    RemoteDevContainerProgress,
