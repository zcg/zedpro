    ...
    fn handle_add_to_workspace(
        ...
        self.picker.update(cx, |picker, cx| {
            ...
            if let Some(ProjectPickerEntry::RecentProject(hit)) =
                ...
                && let Some((_, location, paths, _)) =
                    picker.delegate.workspaces.get(hit.candidate_id)
                && matches!(location, SerializedWorkspaceLocation::Local)
            {
                picker
                    .delegate
                    .add_project_to_workspace(paths.paths().to_vec(), window, cx);
            }
        });
    }
}
...
impl PickerDelegate for RecentProjectsDelegate {
    ...
    fn render_match(
        ...
        match self.filtered_entries.get(ix)? {
            ...
            ProjectPickerEntry::RecentProject(hit) => {
                let _popover_style = matches!(self.style, ProjectPickerStyle::Popover);
    ...
    fn render_footer(&self, _: &mut Window, cx: &mut Context<Picker<Self>>) -> Option<AnyElement> {
        ...
        let _secondary_footer_actions: Option<AnyElement> = match selected_entry {
                ...
                .child(
                    PopoverMenu::new("actions-menu-popover")
                        ...
                        .menu({
                            ...
                            let show_add_to_workspace = !create_new_window;
