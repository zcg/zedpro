...
pub use multi_workspace::{
    ...
    MultiWorkspace, MultiWorkspaceEvent, NewThread, NewWorkspaceInWindow, NextProject,
    NextProjectGroup, NextThread, NextWorkspace, NextWorkspaceInWindow, PreviousProject,
    PreviousProjectGroup, PreviousThread, PreviousWorkspace, PreviousWorkspaceInWindow,
